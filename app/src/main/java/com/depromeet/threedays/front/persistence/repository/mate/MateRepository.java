...
public interface MateRepository extends JpaRepository<MateEntity, Long> {
	...
	Optional<MateEntity> findFirstByHabitIdAndStatusAndDeletedFalseOrderByCreateAtDesc(final Long habitId, final MateStatus status);
	...
	Optional<MateEntity> findFirstByHabitIdAndStatusOrderByCreateAtDesc(final Long habitId, final MateStatus status);

	void deleteAllByMemberId(final Long memberId);

	Optional<MateEntity> findByMemberIdAndDeletedFalseAndStatus(final Long memberId, final MateStatus status);
}
